    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">Gerencie os professores da escola</p>
        </div>
          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
              ...
              <div className="grid gap-6 py-4">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold text-foreground">Vinculação Acadêmica</h3>
      ...
      {filteredTeachers.length === 0 ? (
        <Card className="border border-border">
          <CardContent className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-foreground mb-2">Nenhum professor encontrado</h3>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <Avatar className="h-12 w-12">
                      <AvatarFallback className="bg-blue-500/10 text-blue-600 dark:bg-blue-500/15 dark:text-blue-200">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 mt-1">
                        <Badge className={
                          teacher.status === 'active' ? 'border-green-500/30 bg-green-500/10 text-green-700 dark:bg-green-500/15 dark:text-green-200' : 
                          teacher.status === 'pendente' ? 'border-yellow-500/30 bg-yellow-500/10 text-yellow-700 dark:bg-yellow-500/15 dark:text-yellow-200' : 
                        ...
                        {teacher.subjects && teacher.subjects.length > 0 ? (
                          <div className="rounded-lg bg-blue-500/10 p-3 dark:bg-blue-500/15">
                            ...
                            <div className="space-y-1">
                              {teacher.subjects.slice(0, 2).map((subject) => (
                                <div key={subject.id} className="text-xs text-blue-700 dark:text-blue-200">
                          ...
                          <div className="rounded-lg bg-muted/60 p-3">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm text-muted-foreground">Nenhuma disciplina atribuída</span>
                            </div>
                          </div>
                        )}
                      </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Badge className={
                    selectedTeacher.status === 'active' ? 'border-green-500/30 bg-green-500/10 text-green-700 dark:bg-green-500/15 dark:text-green-200' : 
                    selectedTeacher.status === 'pendente' ? 'border-yellow-500/30 bg-yellow-500/10 text-yellow-700 dark:bg-yellow-500/15 dark:text-yellow-200' : 
                    'border-red-500/30 bg-red-500/10 text-red-700 dark:bg-red-500/15 dark:text-red-200'
                  }>
            ...
            <div className="space-y-3">
              ...
              <div className="border rounded-lg p-4 max-h-40 overflow-y-auto">
                ...
                {(!subjects || subjects.length === 0) && (
                  <p className="text-muted-foreground text-sm">Nenhuma disciplina disponível</p>
                )}
              </div>
            </div>
      ...
      <Dialog open={isConfirmDeleteDialogOpen} onOpenChange={setIsConfirmDeleteDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle className="text-destructive">⚠️ï¸ Confirmação Necessária</DialogTitle>
            <DialogDescription>
