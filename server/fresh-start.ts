...
async function freshStart() {
  try {
    console.log("🆕 Iniciando do zero - Fresh Start!");
    
    // 1. Deletar o arquivo do banco de dados
    ...
    // Aguardar um pouco para garantir que o arquivo foi removido
    ...
    // 2. Criar usuários com credenciais corretas
    ...
    // 5. Criar relacionamentos turma-disciplina-professor
    ...
    // 7. Criar atividades variadas e interessantes
    ...
    // 8. Criar algumas submissões de exemplo
...
freshStart()
  .then(() => {
    ...
    console.log("💡 Agora você pode acessar o sistema com as credenciais acima!");
    process.exit(0);
  })
  .catch((error) => {
